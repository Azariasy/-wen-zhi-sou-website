...
class ModernSearchResultItem(QListWidgetItem):
    """现代化搜索结果列表项"""
...
class OptimizedQuickSearchDialog(QDialog):
    """优化版快速搜索对话框"""
    ...
    def set_search_results(self, results):
        ...
        for result in results:
            ...
            item = ModernSearchResultItem(title, path, None, preview, file_type)
...
if __name__ == "__main__":
    ...
    dialog = OptimizedQuickSearchDialog()
